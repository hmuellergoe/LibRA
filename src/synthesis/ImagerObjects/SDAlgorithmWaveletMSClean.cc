...
#include <synthesis/ImagerObjects/SDAlgorithmWaveletMSClean.h>
...
namespace casa { //# NAMESPACE CASA - BEGIN
  ...
  SDAlgorithmWaveletMSClean::~SDAlgorithmWaveletMSClean()
  {

  }

  Long SDAlgorithmWaveletMSClean::estimateRAM(const vector<int>& imsize){
    Long mem=0;
    IPosition shp;
    if(itsImages)
  ...
  void SDAlgorithmWaveletMSClean::finalizeDeconvolver()
  {
